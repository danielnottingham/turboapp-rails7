      ...
      if @message.save
        format.turbo_stream do
          render turbo_stream: [
            ...
            turbo_stream.update('notice', "Message #{@message.id} was successfully created.")
          ]
        end
      ...
      if @message.update(message_params)
        format.turbo_stream do
          render turbo_stream: [
            ...
            turbo_stream.update('notice', "Message #{@message.id} was successfully updated.")
          ]
        end
    ...
    respond_to do |format|
      format.turbo_stream do
        render turbo_stream: [
          ...
          turbo_stream.update('message_counter', html: Message.count),
          turbo_stream.update('notice', "Message #{@message.id} was successfully destroyed.")
        ]
      end
